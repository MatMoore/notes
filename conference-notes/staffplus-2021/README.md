...
Life experience can also be valuable for empathising with how your software impacts real people.
...
3. Project management (see [How to lead a project - as a software engineer](https://blog.pragmaticengineer.com/how-to-lead-a-project-in-software-development/))
4. People management

You will be a co-leader with other people with a different balance of these skills (you will deliver the same messages, help each other with networking and context)
...
Intercom promotes [the engineering/manager pendulum](https://www.intercom.com/blog/engineering-management-benefits/) rather than management being a fork in the road.

The [session lab library](https://www.sessionlab.com/library) was recommended in chat for facilitating workshops and meetings.

### Bridge the technical and non-technical
- Be adaptive
- Be aware of your context
- Tie technical needs to business needs
 
"whatever needs to be done to get to where we all want to go"

### Lead and guide others
You will guide others towards a larger context and flag things that need attention
...
You can have impact across the organisation through mentorship.

Some recommended resources:

- Anarchists Guide book
- Team Topologies - good for delivering a complicated project
- [The Culture Code](https://www.amazon.co.uk/Culture-Code-Secrets-Highly-Successful/dp/1847941273/ref=asc_df_1847941273/?tag=googshopuk-21&linkCode=df0&hvadid=310737150369&hvpos=&hvnetw=g&hvrand=3383389302035200464&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9046887&hvtargid=pla-527150828343&psc=1)
...
- It's hard because of the slow feedback cycles
- Could there be Katas?
...
- Partnering with a manager at the same level (probably a manager of managers) is a bit like working with product managers and delievery managers. In past roles I have also worked in partnership with people at a higher level to me.
...
- you get pidgeon holed into particular roles
- there is poor communication of business problems

*There are different scopes for autonomy: Personal, Team, Department, Company
